...
if uploaded_file:
    ...
    if eliminarfondo or marcadeagua or ambos:
        ...
        if eliminarfondo and removed_image is not None:
            st.image(removed_image, caption="Imagen sin fondo", width="stretch")
        ...
        if marcadeagua:
            ...
            st.image(watermarked_image, caption="Imagen con Marca de Agua", width="stretch")
        ...
        if ambos and removed_image is not None:
            ...
            st.image(watermarked_image, caption="Imagen sin fondo y con Marca de Agua", width="stretch")
            with tempfile.NamedTemporaryFile(suffix=".png", delete=False) as wm_tmp:
                watermarked_image.save(wm_tmp.name)
                with open(wm_tmp.name, "rb") as file:
                    st.download_button(
